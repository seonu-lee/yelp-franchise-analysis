...
![PART2 FPI 구간별 고유 키워드](results/step5_burger_fpi_keywords.png)

### Figure
`results/step5_burger_fpi_keywords.png`
...
![매개효과 분석 — FPI → 별점 → 폐업여부](results/step4_burger_mediation.png)

### Figure
`results/step4_burger_mediation.png`
...
![생존 vs 고전 브랜드 TF-IDF 키워드 차이](results/step5_burger_survival_tfidf.png)

### Figure
`results/step5_burger_survival_tfidf.png`
...
![생존 vs 고전 브랜드 N-gram 분석](results/step5_burger_ngram.png)

### Figure
`results/step5_burger_ngram.png`
...
![VADER 감성 강도 비교 — 생존 vs 고전 브랜드 (HP 구간)](results/step5_burger_sentiment_intensity.png)

### Figure
`results/step5_burger_sentiment_intensity.png`
...
![LDA 토픽 모델링 — 생존 vs 고전 브랜드 (HP 구간)](results/step5_burger_lda.png)

### Figure
`results/step5_burger_lda.png`
...
![프랜차이즈 직접 언급 분석 — 생존 vs 고전 브랜드](results/step5_burger_franchise_mention.png)

### Figure
`results/step5_burger_franchise_mention.png`
...
![시계열 감성 변화 — 생존 vs 고전 브랜드 (2006~2018)](results/step5_burger_timeseries.png)
...
![고전 브랜드 시기별 키워드 변화](results/step5_burger_temporal_change.png)

### Figure
`results/step5_burger_temporal_change.png`
...
![생존 브랜드 시기별 키워드 변화](results/step5_burger_survivor_temporal.png)

### Figure
`results/step5_burger_survivor_temporal.png`
...
![생존 브랜드 vs 프랜차이즈 차별화 분석](results/step5_burger_vs_franchise.png)

### Figure
`results/step5_burger_vs_franchise.png`
...
| 파일 | 내용 |
|---|---|
| [fpi_map_burger.html](results/fpi_map_burger.html) | 연속형 FPI 지도 (색상: 빨강=고압력, 초록=저압력, 마커 크기=리뷰수) |
| [fpi_map_burger_group.html](results/fpi_map_burger_group.html) | FPI 구간별 지도 (NP=파랑, LP=주황, HP=빨강) |
| [fpi_map_burger_survival.html](results/fpi_map_burger_survival.html) | 생존/고전 브랜드 위치 지도 |
